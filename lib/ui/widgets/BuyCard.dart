...
//                             child: Text(
//                               '${ convertFromStringToRange( widget.carData.bid_price.toString() )} AED',
...
class _LiveCardState extends State<LiveCard>   {
  ...
  void calculateDur() {
    setState((){
      actual=Utils().getLiveDuration(widget.carData.end_date);
    });
  }
  @override
  void dispose() {
             ...
             Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text('${Utils().printDuration(actual)}',style: FCITextStyle.bold(14),),
                ],
              ),
            ),
